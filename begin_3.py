...
try:
    ...
    generate_btn.grid(row=current_row, column=0, padx=5, pady=10)
    
    save_inputs_btn = ttk.Button(scrollable_frame, text="Save Inputs to JSON", 
    ...
    save_inputs_btn.grid(row=current_row, column=1, padx=5, pady=10)
    
    download_inputs_btn = ttk.Button(scrollable_frame, text="Download Input Fields", 
                                     command=lambda: save_inputs_to_txt(entries, bins_entries, range_entries, 
                                                                        bin_name_entries, check_vars, 
                                                                        cross_coverage_entries, wifi_specs_vars))
    download_inputs_btn.grid(row=current_row, column=2, padx=5, pady=10)
