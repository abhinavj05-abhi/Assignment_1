        ...
        try:
            ...
            if pd.isna(bins_value):
                ...
                try:
                    ...
                    print ("Warning: Invalid bins value for parameter '{param}': {bins_value}. Using default value None.")
                    default_bins[param] = None
        except Exception as e:
...
try:
    ...
    for gen in generations:
        try:
            ...
            cross_frame.grid_columnconfigure(2, weight=1)
            ...
            def add_cross_coverage_field(frame, row, gen=gen):
                try:
                    ...
                    if row == 0:
                        ...
                        header_frame.grid_columnconfigure(0, minsize=200)
                        header_frame.grid_columnconfigure(1, minsize=400)
                        header_frame.grid_columnconfigure(2, minsize=400)
                        header_frame.grid_columnconfigure(3, minsize=40)
                        
                        ttk.Label(header_frame, text="Cross Name", font=("Arial", 9)).grid(row=0, column=0, sticky="w", padx=2)
                        ttk.Label(header_frame, text="Coverpoints (comma-separated)", font=("Arial", 9)).grid(row=0, column=1, sticky="w", padx=2)
                        ttk.Label(header_frame, text="Illegal Bins (semicolon-separated, optional)", font=("Arial", 9)).grid(row=0, column=2, sticky="w", padx=2)
                    ...
                    if row < 9:
                        ...
                        plus_btn.grid(row=input_row, column=3, padx=2, pady=2)
                except Exception as e:
